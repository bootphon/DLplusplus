...
:class:`~audio_pipeline.packaging.packer.Packer`.

Usage:
    python -m audio_pipeline.pipeline.package seedlings --sample 0.01
    python -m audio_pipeline.pipeline.package seedlings --max_clip 600
"""
...
from audio_pipeline.packaging.packer import Packer
from audio_pipeline.packaging.stats import load_all_stats, save_all_stats
from audio_pipeline.paths import PROJECT_PATHS
from audio_pipeline.plotting.figures import save_all_figures
...
def _run_comparison(ds, has_vad: bool) -> None:
    ...
    from audio_pipeline.plotting.compare import (
        calculate_metrics,
        diagnose_low_iou,
        load_parquet_dir,
        plot_dashboard,
...
def _parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog=(
            "Examples:\n"
            "  python -m audio_pipeline.pipeline.package seedlings --sample 0.01\n"
            "  python -m audio_pipeline.pipeline.package seedlings --audio_fmt wav\n"
        ),
    )
...
def main() -> None:
    ...
    fig_dir = PROJECT_PATHS.figures_dir / args.dataset
