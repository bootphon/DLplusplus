...
Usage (login node):
    uv run python -m audio_pipeline.pipeline.vtc_clip_alignment seedlings_10
"""
...
# ---------------------------------------------------------------------------
# Figures (extracted to audio_pipeline.plotting.clip_alignment)
# ---------------------------------------------------------------------------
...
def main(dataset: str) -> None:
    ...
    # Figures
    fig_dir = PROJECT_PATHS.figures_dir / dataset / "vtc"
    from audio_pipeline.plotting.clip_alignment import save_clip_alignment_figures
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print(
            "Usage: python -m audio_pipeline.pipeline.vtc_clip_alignment <dataset>",
            file=sys.stderr,
        )
        sys.exit(1)
    main(sys.argv[1])
