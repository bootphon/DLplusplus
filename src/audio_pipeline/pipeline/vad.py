...
Usage:
    python -m audio_pipeline.pipeline.vad chunks30
    python -m audio_pipeline.pipeline.vad chunks30 --sample 500
"""
...
from audio_pipeline.core.checkpoint import (  # noqa: E402
    CKPT_META,
    CKPT_SEGS,
    clear_checkpoint,
)
from audio_pipeline.core.parallel import run_vad_parallel  # noqa: E402
...
def main() -> None:
    ...
    if completed_ids:
        ...
        print(f"  Resume: {before - len(wavs)} done, {len(wavs)} remaining")
    ...
    print(f"Saved: {len(vad_raw_df):,} raw, {len(vad_merged_df):,} merged segments")
