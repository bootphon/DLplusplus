...
Usage:
    python -m audio_pipeline.analysis.vtc_on_clips seedlings_10
    python -m audio_pipeline.analysis.vtc_on_clips seedlings_10 \\
...
def main(
    ...
    logger.info(
        f"  Processed : {n_processed} clips  ({n_errors} errors, {n_skipped} skipped)"
    )
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        ...
        epilog=(
            ...
            "  python -m audio_pipeline.analysis.vtc_on_clips seedlings_10 --device cpu\n"
        ),
    )
