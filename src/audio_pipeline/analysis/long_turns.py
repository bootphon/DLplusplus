...
Usage (login node — no GPU required):
    uv run python -m audio_pipeline.analysis.long_turns seedlings_10
    uv run python -m audio_pipeline.analysis.long_turns seedlings_10 --threshold 30 --top-n 20 --pad 5
"""
