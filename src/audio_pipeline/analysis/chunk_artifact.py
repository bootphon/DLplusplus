...
Usage
-----
    python -m audio_pipeline.analysis.chunk_artifact [dataset]   # default: seedlings_10
"""
...
def main() -> None:
    ...
    base = PROJECT_PATHS.output_dir / args.dataset
    raw_path = base / "vtc_raw"
    merged_path = base / "vtc_merged"

    out = args.output_dir or PROJECT_PATHS.figures_dir / args.dataset / "chunk_artifact"
