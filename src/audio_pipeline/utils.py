...
def resolve_manifest(manifest_arg: str) -> Path:
    ...
    manifests_dir = PROJECT_PATHS.manifests_dir
...
def get_dataset_paths(dataset: str) -> DatasetPaths:
    ...
    return DatasetPaths(
        ...
        output=PROJECT_PATHS.output_dir / dataset,
        figures=PROJECT_PATHS.figures_dir / dataset,
    )
...
BENCHMARK_LOG = PROJECT_PATHS.logs_dir / "benchmarks.jsonl"
